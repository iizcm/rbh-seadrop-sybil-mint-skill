...
| Field | Value |
| --- | --- |
| **Name** | `rbh-seadrop-sybil-mint-skill` |
...
cp -r web3/rbh-seadrop-sybil-mint ~/.hermes/skills/web3/rbh-seadrop-sybil-mint/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/rbh-seadrop-sybil-mint-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/rbh-seadrop-sybil-mint-skill.git ~/.hermes/skills/web3/rbh-seadrop-sybil-mint/
```
...
```text
skill_view(name="web3/rbh-seadrop-sybil-mint")
```
...
```text
Use the rbh seadrop sybil mint skill to <describe your specific task here>
```
...
```text
Gunakan skill rbh seadrop sybil mint untuk <deskripsikan tugas spesifik Anda di sini>
```
